...
class room(db.Model):
    ...
    def get_all_by_user(cls, user_id, visibility='public'):
        if visibility == 'public':
            return cls.query.filter_by(reserved_user_id=reserved_user_id, room_is_public=True).all()
        elif visibility == 'private':
            return cls.query.filter_by(reserved_user_id=reserved_user_id, room_is_public=False).all()
        else:
            return cls.query.filter_by(reserved_user_id=reserved_user_id).all()
